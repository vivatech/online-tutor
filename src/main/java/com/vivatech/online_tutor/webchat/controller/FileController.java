...
import com.vivatech.online_tutor.service.FileStorageService;
...
public class FileController {
    ...
    public ResponseEntity<Map<String, String>> uploadFile(@RequestParam("file") MultipartFile file) {
        try {
            if (file.isEmpty()) {
                throw new CustomExceptionHandler("File is empty");
            }

            // Validate file size (10MB max)
            if (file.getSize() > 10 * 1024 * 1024) {
                throw new CustomExceptionHandler("File size exceeds 10MB limit");
            }
